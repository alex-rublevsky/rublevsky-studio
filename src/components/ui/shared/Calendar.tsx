...
function Calendar({
  ...
  const defaultComponents = {
    ...
    // Override button components to ensure they're clickable
  ...
  return (
    <DayPicker
      ...
      className={cn("w-fit p-3 bg-background rounded-lg border border-border pointer-events-auto", className)}
