      ...
      <div className={`relative ${isMobileOrTablet ? "w-full max-w-screen-sm mx-auto" : "w-max mx-auto"}`}>
        <div 
          ...
          style={{
            ...
            maskImage: 'url(#frostyGlassMaskSkeleton)',
            WebkitMaskImage: 'url(#frostyGlassMaskSkeleton)',
            pointerEvents: 'none'
          }}
        />
        ...
        >
          <mask id="frostyGlassMaskSkeleton">
            <rect
              width="100%"
              height="100%"
              fill="white"
                ...
                <div className="flex flex-col gap-2 flex-shrink-0">
                  ...
                  <div className="h-9 w-[15ch] px-3 py-2 text-sm rounded-md border border-border bg-background relative">
                    <span className="text-transparent flex items-center justify-between">
                      Relevant
                      <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-4"><path d="m4.93179 5.43179c0.20081-0.20081 0.52632-0.20081 0.72713 0l2.34108 2.34108 2.3411-2.34108c0.2008-0.20081 0.5263-0.20081 0.7271 0 0.2008 0.20081 0.2008 0.52632 0 0.72713l-2.7071 2.7071c-0.2008 0.2008-0.5263 0.2008-0.7271 0l-2.7071-2.7071c-0.20081-0.20081-0.20081-0.52632 0-0.72713z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"></path></svg>
                    </span>
              ...
              <div className="space-y-4 min-w-[13rem] w-full sm:max-w-[20rem] pt-3 pb-5 lg:pt-0">
                ...
                <div className="relative flex pt-1.5 w-full touch-none select-none items-center data-[orientation=vertical]:h-full data-[orientation=vertical]:w-auto data-[orientation=vertical]:flex-col">
                  <div className="relative grow overflow-hidden rounded-full bg-secondary data-[orientation=horizontal]:h-0.5 data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-2 h-0.5 w-full">
                    <div className="absolute bg-primary data-[orientation=horizontal]:h-full data-[orientation=vertical]:w-full h-full" style={{ left: '0%', width: '100%' }} />
                  </div>
                  <div className="block h-5 w-5 rounded-full border-2 border-primary bg-background transition-colors focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-ring/40 data-disabled:cursor-not-allowed cursor-grab" style={{ position: 'absolute', left: '0%', marginLeft: '-10px' }} />
                  <div className="block h-5 w-5 rounded-full border-2 border-primary bg-background transition-colors focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-ring/40 data-disabled:cursor-not-allowed cursor-grab" style={{ position: 'absolute', left: '100%', marginLeft: '-10px' }} />
                </div>
              </div>
            </>
          ) : (
