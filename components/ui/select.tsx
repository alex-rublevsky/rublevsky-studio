...
// Add new SelectWrapper component
interface SelectWrapperProps extends React.ComponentProps<typeof SelectRoot> {
  label?: string;
  required?: boolean;
  children: React.ReactNode;
}

const Select = React.forwardRef<HTMLDivElement, SelectWrapperProps>(
