  ...
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ...
      className={cn(
        ...
        "max-h-[95vh] transition-transform duration-300 ease-in-out",
        className
      )}
      {...props}
    >
...
const DrawerHeader = ({
  ...
  <div
    className={cn(
      "grid gap-1.5 p-4 text-center sm:text-left flex-shrink-0",
      className
    )}
    {...props}
  />
...
const DrawerBody = ({
  ...
  <div
    className={cn(
      "flex-1 overflow-y-auto px-4 py-2 scrollbar-none min-h-0",
      className
    )}
    {...props}
  />
...
const DrawerFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col gap-2 p-4 flex-shrink-0 border-t border-border bg-background",
      className
    )}
    {...props}
  />
